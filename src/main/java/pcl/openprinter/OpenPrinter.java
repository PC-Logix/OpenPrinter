...
public class OpenPrinter {
	...
	public static final String MODID = "openprinter";
    	...
    	{
        	ItemStack nuggetIron   = li.cil.oc.api.Items.IronNugget;
        	ItemStack redstone     = new ItemStack(Items.redstone);
        	ItemStack microchip    = li.cil.oc.api.Items.MicrochipTier1;
        	ItemStack pcb		   = li.cil.oc.api.Items.PrintedCircuitBoard;
