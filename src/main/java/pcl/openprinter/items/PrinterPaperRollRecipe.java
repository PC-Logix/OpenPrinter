...
public class PrinterPaperRollRecipe implements IRecipe
{
    ...
    public boolean matches (InventoryCrafting inventory, World world) {
        if (inventory.getSizeInventory() >= 9) {
            ...
            return stack00.getItem() == Item.paper && stack00.stackSize == 64
                && stack01.getItem() == Item.paper && stack01.stackSize == 64
                && stack10.getItem() == Item.paper && stack10.stackSize == 64
                && stack11.getItem() == Item.paper && stack11.stackSize == 64;
        }
        else
            return false;
    }
